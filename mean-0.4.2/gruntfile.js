...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      clientLESS: {
        files: _.union(defaultAssets.client.less, defaultAssets.client.lib.less),
        tasks: ['less', 'csslint'],
        options: {
          livereload: true
        }
    ...
    less: {
      dist: {
        files: [{
          expand: true,
          src: _.union(defaultAssets.client.less, defaultAssets.client.lib.less),
          ext: '.css',
          rename: function (base, src) {
  ...
  grunt.registerTask('default', ['env:dev', 'lint', 'mkdir:upload', 'copy:localConfig', 'concurrent:default', 'cssmin']);
